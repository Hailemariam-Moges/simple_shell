...
int _env(char **arg, env_t *env_p);
int _setenv(char **arg, env_t *env_p, int buf_size);
int _unsetenv(char **arg, env_t *env_p);
int _cd(char **arg, env_t *env_p, int buf_size);
int _help(char **arg);
int _exit(char **arg_list, env_t *env_p, int buf_size);
int _history(char **arg, env_t *env_p, int buf_size);

/* list of builtin help printouts */
int _exit_help(void);
int _env_help(void);
int _setenv_help(void);
int _unsetenv_help(void);
int _cd_help(void);
int _history_help(void);
int _help_help(void);
int _alias_help(void);
#endif
