...
void (*_getCustomFunction(char *pCommand))(appData_t *);
...
void _help(appData_t *pData);
void _helpHelp(void);
int _inArray(char pChar, char *pArray);
appData_t *_initData(char **pArgv);
void _initEnvData(appData_t *pData);
...
char **_parsingPathEnvironment(appData_t *pData);
